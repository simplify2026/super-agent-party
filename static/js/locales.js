...
key3`,
        ...
        'minilmNotice':'启用知识库功能前，你必须配置词嵌入模型，下方提供了一种轻量级的本地模型，你可以点击下载到本地，已启用词嵌入模型，或者选择你在模型服务中添加的其他词嵌入模型',
        'minilmNotice2':'第一个选项是一个本地词嵌入模型，需要你手动点击下载，请在这个界面下载',
        'minilmNotice3':'启用角色长期记忆功能前，你必须配置词嵌入模型，下方提供了一种轻量级的本地模型，你可以点击下载到本地，已启用词嵌入模型，或者选择你在模型服务中添加的其他词嵌入模型',
...
Key3`,
        ...
        'minilmNotice': 'Before enabling the knowledge base feature, you must configure a word embedding model. A lightweight local model is provided below. You can click to download it locally, enable the word embedding model, or choose another word embedding model you have added in the model service.',
        ...
        'minilmNotice3': 'Before enabling the character long-term memory feature, you must configure a word embedding model. A lightweight local model is provided below. You can click to download it locally, enable the word embedding model, or choose another word embedding model you have added in the model service.',
